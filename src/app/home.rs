            ...
            children: Rsx(hypertext::rsx! {
                <div class="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
                    ...
                    <div class="flex justify-center space-x-4 my-4">
                        ...
                        >
                        <i class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 fab fa-github fa-xl"></i>
                        </a>
                        <a
                        ...
                        >
                        <i
                            class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 fab fa-linkedin fa-xl"
                        ></i>
                        </a>
                        <a
                        ...
                        >
                        <i
                            class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 fab fa-instagram fa-xl"
                        ></i>
                        </a>
                        <a
                        ...
                        >
                        <i
                            class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 fab fa-twitter fa-xl"
                        ></i>
                        </a>
                        <a
                        ...
                        >
                        <i
                            class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 fas fa-external-link fa-xl"
                        ></i>
                        </a>
                    </div>
                </div>
