            ...
            <div class="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
                <nav class="my-16 animate-fade-in">
                    <div class="flex items-center justify-center gap-4">
                        {NAVIGATION.iter().zip(1..).map(|(item, _i)| rsx! {
                            <a
                                href={item.href}
                ...
                <div class="my-16 mx-4 text-center animate-fade-in">
                    ...
                    Hi, Im Jonathan, a proud believer, lover of music, philosophy, theology and technology.
                    <br />Im a Software Engineer at
                    <a
                        target="_blank"
                    ...
                    <div class="pt-8">
                        <a
                            ...
                            title={"Let's get your questions answered".to_string()}
                        >
                            "Connect with me 🤝"
                        </a>
                    </div>
                ...
                <div class="flex justify-center space-x-4 my-4">
                    <a
                        ...
                        title={"I collaborate on github often".to_string()}
                    >
