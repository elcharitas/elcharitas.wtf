        ...
        <PageLayout title={title}>
            {match &props.post {
                Some(post) => {
                    ...
                    rsx! {
                        <article class="max-w-3xl mx-auto py-3 md:py-6">
                            <header class="mb-7 space-y-3">
                                <a href="/essays" class="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-950 transition-colors mb-1">
                                ...
                                <h1 class="text-3xl md:text-4xl font-bold text-zinc-950 leading-tight">
                                    {&post.title}
                                </h1>
                                <p class="text-base text-zinc-600 leading-relaxed">{&post.brief}</p>
                            ...
                            <footer class="mt-10 pt-6 border-t border-zinc-200 space-y-8">
                                <div id="comments-section">
                                    <h2 class="text-xl font-semibold text-zinc-950 mb-4">"Comments"</h2>
    ...
    obs.observe(box, { childList: true, subtree: true });
                ...
                None => rsx! {
                    <div class="max-w-2xl mx-auto text-center py-10">
                        ...
                        <a
                            href="/essays"
                            class="inline-flex items-center space-x-2 px-4 py-2.5 bg-zinc-100 text-zinc-950 rounded-lg hover:bg-zinc-200 transition-colors font-medium border border-zinc-300"
                        >
